...
class gsp_jukebox_bandindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/band/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(bandList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(bandCount ?: 0)],-1)
printHtmlPart(13)
})
