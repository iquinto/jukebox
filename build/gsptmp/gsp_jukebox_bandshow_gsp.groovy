...
class gsp_jukebox_bandshow_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/band/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("band")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.band)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.band),'method':("DELETE")],2)
printHtmlPart(17)
})
